          ...
          <ul className="sm-panel-list" data-numbering={displayItemNumbering || undefined}>
            {items && items.length ? items.map((it, idx) => (
              <li className="sm-panel-itemWrap" key={it.label + idx}>
                <a className="sm-panel-item" href={it.link} data-index={idx + 1}>
                  <span className="sm-panel-itemLabel">{it.label}</span>
                </a>
              </li>
            )) : <li className="sm-panel-itemWrap"><span className="sm-panel-item"><span className="sm-panel-itemLabel">No items</span></span></li>}
          </ul>
